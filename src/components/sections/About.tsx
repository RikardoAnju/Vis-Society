    ...
    <section id="about" className="py-16 md:py-24 px-4 md:px-8 bg-white">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-12">
          {/* Visi */}
          <div className="p-8 rounded-xl bg-gray-50 border border-transparent transition-all duration-300 ease-out hover:-translate-y-1.5 hover:scale-[1.02] hover:shadow-xl hover:shadow-slate-200/50 hover:bg-white hover:border-slate-100">
            ...
            <h4 className="text-xl font-bold text-black mb-3">{t("about.vision.title")}</h4>
          ...
          {/* Misi - Highlighted */}
          <div className="p-8 rounded-xl transition-all duration-300 ease-out hover:-translate-y-1.5 hover:scale-[1.02] hover:shadow-xl hover:shadow-teal-950/20" style={{ backgroundColor: colors.primary }}>
            ...
            <h4 className="text-xl font-bold text-white mb-4">{t("about.mission.title")}</h4>
          ...
          {/* Core Values */}
          <div className="p-8 rounded-xl bg-gray-50 flex flex-col justify-between border border-transparent transition-all duration-300 ease-out hover:-translate-y-1.5 hover:scale-[1.02] hover:shadow-xl hover:shadow-slate-200/50 hover:bg-white hover:border-slate-100">
            <div>
              <svg className="w-7 h-7 mb-5" fill="none" stroke="black" strokeWidth="1.6" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" d="M21 8.25c0-2.485-2.099-4.5-4.688-4.5-1.935 0-3.597 1.126-4.312 2.733-.715-1.607-2.377-2.733-4.313-2.733C5.1 3.75 3 5.765 3 8.25c0 7.22 9 12 9 12s9-4.78 9-12z" />
              </svg>
              <h4 className="text-xl font-bold text-black mb-3">{t("about.coreValues.title")}</h4>
            ...
            <div className="w-full relative mt-2">
              ...
              <div className="grid grid-cols-1 md:grid-cols-5 gap-6 md:gap-4 justify-items-center relative">
                {departments.map((dept, idx) => (
                  <div key={idx} className="p-5 bg-slate-50/50 rounded-2xl border border-slate-100/80 md:bg-transparent md:border-0 md:p-0 w-full max-w-[290px] md:max-w-none flex flex-col items-center">
